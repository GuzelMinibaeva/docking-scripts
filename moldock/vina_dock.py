...
def main():
    ...
    parser.add_argument('--module_name', metavar='STRING', required=False, default='vina_dock',
                        help='type docking.')
    parser.add_argument('--config_file', metavar='STRING', required=False, help='configuration file *.yml.'
                        'Config uncludes parameters:'
                        'protein - input PDBQT file with a prepared protein. It will be omitted if output DB exists,\n'
                        'protein_setup - input text file with Vina docking setup. It will be omitted if output DB exists,\n'
                        'exhaustiveness - exhaustiveness of docking search,\n'
                        'seed - seed to make results reproducible,\n'
                        'n_poses - the number of poses generated by Vina,\n'
                        'verbose.')
